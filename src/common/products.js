const products = [
  ...
  },
  {
    ...
    summary: `기초부터 탄탄하게, 두고두고 써먹는, 2021 최신 버전의 HTML5 바이블! 웹 디자인과 웹 개발 입문은 물론이고 블로그, 전자책, 쇼핑몰 만들기 등 HTML은 우리가 모바일과 PC로 보는 모든 곳에 존재합니다. HTML은 더 이상 웹 디자이너나 웹 개발자만 할 줄 아는 외계어가 아닌, 가장 모던한 글쓰기 방식이라고 할 수 있습니다. (심지어 이 책도 HTML로 작성되었습니다!) HTML 조금, CSS 조금...'대충...', '조금...' 배우는 건 그만!\n제대로 공부한 프로그래밍 언어는 수영이나 자전거 타기와 같아서, 시간이 지나도 몸이 기억합니다. 딱 한 번, 1 ~ 2주만 투자하면 전 세계 공용으로 사용되는 새로운 언어를 배울 수 있습니다. 본 책은 프로그래밍을 한 번도 접해본 적 없는 사람도 HTML5를 다룰 수 있게끔 꼼꼼한 이론, 다양한 예제 코드와 따라 하는 웹 문서 작성까지 담았습니다.`,
  },
  {
    id: 3,
    title: 'CSS3 독학백서',
